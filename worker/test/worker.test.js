...
test('health reports v2.3.0',async()=>{const r=await worker.fetch(new Request('https://x/api/health'));assert.equal(r.status,200);assert.equal((await r.json()).version,'2.2.9')});
